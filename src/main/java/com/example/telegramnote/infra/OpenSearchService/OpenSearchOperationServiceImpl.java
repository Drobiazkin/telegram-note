...
public class OpenSearchOperationServiceImpl implements OpenSearchOperationService {
    ...
    public void deleteRequest(String id) {
        ...
        DeleteResponse deleteResponse = openSearchService.createRestHighLevelClient().delete(deleteDocumentRequest, RequestOptions.DEFAULT);
    }

    @SneakyThrows
    public void deleteIndexRequest() {
        DeleteIndexRequest deleteIndexRequest = new DeleteIndexRequest(index);
        AcknowledgedResponse deleteIndexResponse = openSearchService.createRestHighLevelClient().indices().delete(deleteIndexRequest, RequestOptions.DEFAULT);
